...
class VehicleImageListScreen extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        for (let index = 0; index < itemObj.images.length; index++) {
            const element = itemObj.images[index];
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ backgroundColor: AppColors.toolbarColor }}>
                    <Toolbar headerName={itemObj.model} isFilterIconShow={true} isInnerScreen={true} />
                </View>
...
export default VehicleImageListScreen;
