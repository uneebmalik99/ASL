...
import { View, Text, TouchableOpacity, StyleSheet, FlatList, Image, TextInput, BackHandler, ActivityIndicator } from 'react-native'
...
class VehcileOne extends Component {
    constructor(props) {
        super(props)
