...
class VehcilDetailScreen extends Component {
    constructor(props) {
        super(props);
                        ...
                        let vehicleDetail = [
                            {
                                ...
                                'buyerNo': vehicleDetailObj.buyer_id,
                                ...
                                'keys': vehicleDetailObj.keys == 1 ? 'YES' : 'NO',
                                ...
                                'eta': vehicleDetailObj.vehicleExports != null ? vehicleDetailObj.vehicleExports.export.export_date : '-',
                                ...
                                'invoiceAmount': vehicleDetailObj.invoice ? vehicleDetailObj.invoice.final_total : '-',
                                'paidAmount': vehicleDetailObj.invoice ? vehicleDetailObj.invoice.paid_amount : '-',
                                'totalAmount': vehicleDetailObj.invoice ? vehicleDetailObj.invoice.balance_due : '-'
                            }
                        ]
    ...
    callingImageList = ()=>{
        if (vehicleObj.images!=undefined && vehicleObj.images!='') {
            this.props.navigation.navigate('VehicleImageListScreen', { 'itemObj': vehicleObj, 'baseImagePath': baseImagePath })    
        } else {
            AppConstance.showSnackbarMessage('No Image Found')
        }
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                {/* <View style={{ width: deviceWidth, height: 50, flexDirection: 'row', backgroundColor: AppColors.toolbarColor, alignContent: 'center', alignItems: 'center' }}>
                    ...
                    >
                        <MaterialCommunityIcons name='arrow-left' color={AppColors.white} size={25} />
                    </TouchableOpacity>
...
export default VehcilDetailScreen;